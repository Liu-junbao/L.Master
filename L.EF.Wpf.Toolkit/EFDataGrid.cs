...
namespace System.Windows
{
    ...
    public class EFDataGrid : DataGrid
    {
        ...
        protected override void OnAutoGeneratingColumn(DataGridAutoGeneratingColumnEventArgs e)
        {
            ...
            var displayPropertyNames = DisplayPropertyNames;
            if (displayPropertyNames != null && displayPropertyNames.ContainsKey(propertyName))
            {
                string name = displayPropertyNames[propertyName];
                var column = new GenerateValueDataGridColumn(propertyName, propertyType) { Header = name };
